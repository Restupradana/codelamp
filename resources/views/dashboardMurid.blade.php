...
<body class="flex bg-gray-100 min-h-screen">
    ...
    <aside class="w-64 bg-gray-900 text-white flex flex-col">
        ...
        <nav class="flex-1 px-4 space-y-2">
            ...
            <a href="#" class="block py-2 px-4 rounded hover:bg-gray-700">Profil</a>
            <a href="#" class="block py-2 px-4 rounded hover:bg-gray-700">Kursus</a>
            <a href="#" class="block py-2 px-4 rounded hover:bg-gray-700">Pembayaran</a>
            <a href="#" class="block py-2 px-4 rounded hover:bg-gray-700">Pesan</a>
        </nav>
    </aside>
    ...
    <div class="flex-1 flex flex-col">
        ...
        <div class="p-6">
            ...
            <div class="mb-6">
                <input type="text" placeholder="Search" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-400">
            </div>
