...
<div class="flex items-center gap-2 mb-4">
    ...
    <span class="text-[18px] font-bold text-[#0E1212] leading-[30px]">Edit Instruktur</span>
</div>

<!-- Card Utama -->
<div class="w-full px-6">
    <div class="w-full bg-white shadow-md p-6 rounded-[5px]">
        <form action="{{ route('admin.instruktur.update', $user->id) }}" method="POST" class="space-y-4">
            @csrf
            @method('PUT')

            <!-- Subjudul -->
            <div class="text-[20px] text-[#0E1212] font-normal mb-1">Perbarui Akun Instruktur</div>
            <div class="text-[14px] text-[#9197A0] font-normal mb-6">Edit informasi utama instruktur</div>
            ...
            <div class="text-sm text-[#9197A0] mt-4">
                *Biarkan kata sandi kosong jika tidak ingin mengubah
            </div>
