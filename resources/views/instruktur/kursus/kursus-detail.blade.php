    ...
    <div class="mb-6">
        ...
        <div class="bg-white shadow rounded-xl p-6 space-y-8">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500">Instruktur: {{ $kursus->instruktur->name ?? 'Instruktur tidak ditemukan' }}
                </p>
            </div>
                    ...
                    <div class="bg-gray-50 rounded-lg shadow p-4 max-h-[300px] overflow-y-auto">
                        @forelse ($kursus->materi as $materi)
                            <details class="group py-2 cursor-pointer">
                                <summary
                                    class="flex justify-between items-center text-gray-800 font-medium hover:text-blue-700">
                                    {{ $materi->judul }}
