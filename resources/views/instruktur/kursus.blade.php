...
<div class="flex justify-center">
    <div class="max-w-[1431px] w-full bg-white shadow-md p-6 rounded-[5px]">
        ...
        <!-- Subjudul Data Diri + Tombol Tambahkan + Input Search -->
        ...
        <table class="w-[1375px] h-[327px] border-collapse text-black">
            <thead>
            ...
            <tbody>
                <tr class="bg-[#FFFFFF]">
                    ...
                    <td class="px-4 py-2 border-b border-gray-300">2025-06-01</td>
                    <td class="px-4 py-2 border-b border-gray-300">
                        <img src="cover1.jpg" alt="Cover" class="w-16 h-10 object-cover" />
                    </td>
                    <td class="px-4 py-2 border-b border-gray-300">Judul Kursus 1</td>
                    <td class="px-4 py-2 border-b border-gray-300">Kategori A</td>
                    <td class="px-4 py-2 border-b border-gray-300">Rp100.000</td>
                    <td class="px-4 py-2 border-b border-gray-300">Aktif</td>
                    <td class="px-4 py-2 border-b border-gray-300">50</td>
                    <td class="px-4 py-2 border-b border-gray-300">
                ...
                <tr class="bg-[#E8E6E6]">
                    ...
                    <td class="px-4 py-2 border-b border-gray-300">2025-06-02</td>
                    <td class="px-4 py-2 border-b border-gray-300">
                        <img src="cover2.jpg" alt="Cover" class="w-16 h-10 object-cover" />
                    </td>
                    <td class="px-4 py-2 border-b border-gray-300">Judul Kursus 2</td>
                    <td class="px-4 py-2 border-b border-gray-300">Kategori B</td>
                    <td class="px-4 py-2 border-b border-gray-300">Rp200.000</td>
                    <td class="px-4 py-2 border-b border-gray-300">Tidak Aktif</td>
                    <td class="px-4 py-2 border-b border-gray-300">30</td>
                    <td class="px-4 py-2 border-b border-gray-300">
                        <div class="flex gap-2">
                            <!-- Detail -->
                            <button
                            ...
                            <button
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-white" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-alinejoin="round" d="M6 18L18 6M6 6l12 12" />
                                </svg>
                            </button>
                        </div>
                    </td>
